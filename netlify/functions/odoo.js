  ...
  <param><value><struct></struct></value></param>
    ...
    if (action === 'crear_pago_spei') {
      ...
      try {
        ...
        // Extraer la URL con las instrucciones/CLABE
        let ticketUrl = '';
        try {
          ticketUrl = (pay.transaction_details && pay.transaction_details.external_resource_url) ||
                      (pay.point_of_interaction && pay.point_of_interaction.transaction_data && pay.point_of_interaction.transaction_data.ticket_url) || '';
        } catch(_){}
        ...
        return {statusCode:200, headers, body: JSON.stringify({
          ...
          folio: folio,
          monto: serverTotal,
          ticket_url: ticketUrl       // URL con la CLABE e instrucciones
        })};
      } catch(e) {
